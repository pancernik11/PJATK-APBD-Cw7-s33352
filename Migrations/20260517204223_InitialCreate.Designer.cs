...
namespace PcManager.Migrations
{
    ...
    [Migration("20260517204223_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PcManager.Models.Component", b =>
                {
            ...
            modelBuilder.Entity("PcManager.Models.ComponentManufacturer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PcManager.Models.ComponentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PcManager.Models.PC", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PcManager.Models.PCComponent", b =>
                {
                    b.Property<int>("PCId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PcManager.Models.Component", b =>
                {
                    b.HasOne("PcManager.Models.ComponentManufacturer", "Manufacturer")
                        .WithMany("Components")
                        .HasForeignKey("ComponentManufacturersId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PcManager.Models.ComponentType", "Type")
                        .WithMany("Components")
            ...
            modelBuilder.Entity("PcManager.Models.PCComponent", b =>
                {
                    b.HasOne("PcManager.Models.Component", "Component")
                        .WithMany("PCComponents")
                        .HasForeignKey("ComponentCode")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PcManager.Models.PC", "PC")
                        .WithMany("PCComponents")
                        .HasForeignKey("PCId")
